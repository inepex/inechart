...
public class Axes implements HasViewport{
	...
	private Axis yAxis;
	private Axis y2Axis;
	private CanvasWidget curveCanvas;
	private CanvasWidget xAxisCanvas;
	private CanvasWidget y2AxisCanvas;
	private CanvasWidget yAxisCanvas;
	
	public Axes(CanvasWidget curveCanvasCtx, ModelManager mm, IneChartProperties prop) {
		this.curveCanvas = curveCanvasCtx;
		this.mm = mm;
		this.prop = prop;
	}
...
//	}
	...
	public void addXAxis(Axis xAxis, CanvasWidget xAxisCanvas){
		this.xAxis = xAxis;
		this.xAxisCanvas = xAxisCanvas;
	} 
	
	public void addYAxis(Axis yAxis, CanvasWidget yAxisCanvas){
		this.yAxis = yAxis;
		this.yAxisCanvas = yAxisCanvas;
	}
	
	public void addY2Axis(Axis y2Axis, CanvasWidget y2AxisCanvas){
		this.y2Axis = y2Axis;
...
//	}
//	
//	public void drawGridLines(int min, int max, Canvas backBuffer){
//		if(yAxis != null && yAxis.getTickDistance() != 0){
//			VerticalAxisDrawingInfo info = (VerticalAxisDrawingInfo) yAxis.getDrawingInfo();
//			if(info.hasGridLines()){
//				double tick = getFirstVisibleTick(mm.getyMin(),yAxis);
...
//	}
//	
//	public void drawAxes(int min, int max, Canvas backBuffer){
//		if(xAxis != null && xAxis.getTickDistance() != 0){
//			AxisLocation pos = ((HorizontalAxisDrawingInfo) xAxis.getDrawingInfo()).getAxisLocation();
...
//	private void drawX(double min, double max, Canvas context, int dx, int dy){
//		HorizontalAxisDrawingInfo info = (HorizontalAxisDrawingInfo) xAxis.getDrawingInfo();
